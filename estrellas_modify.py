...
#Una vez definida nuestra clase, creamos las siguientes funciones pertenecientes al mismo objeto Estrella.
    ...
    def scharwschild(self):
        G = 6.67430e-11 #La constante de gravitación universal.
        c = 300000000 #La velocidad de la luz en el vacío aproximadamente.
        return 2 * G * self._masa / (c**2 * self._radio)
